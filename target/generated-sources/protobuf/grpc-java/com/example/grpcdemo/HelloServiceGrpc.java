...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcdemo.HelloRequest,
      com.example.grpcdemo.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.grpcdemo.HelloRequest.class,
      responseType = com.example.grpcdemo.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpcdemo.HelloRequest,
      com.example.grpcdemo.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpcdemo.HelloRequest, com.example.grpcdemo.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpcdemo.HelloRequest, com.example.grpcdemo.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcdemo.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcdemo.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.example.grpcdemo.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcdemo.HelloReply> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void sayHello(com.example.grpcdemo.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcdemo.HelloReply> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public com.example.grpcdemo.HelloReply sayHello(com.example.grpcdemo.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpcdemo.HelloReply> sayHello(
        com.example.grpcdemo.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.grpcdemo.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpcdemo.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpcdemo.HelloRequest,
              com.example.grpcdemo.HelloReply>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpcdemo.HelloWorldProto.getDescriptor();
    }
